...
namespace UsbLibrary
{
    ...
    public class Win32Usb
    {
        ...
        [DllImport("setupapi.dll", CharSet = CharSet.Auto, SetLastError = true)] protected static extern bool SetupDiEnumDeviceInterfaces(IntPtr lpDeviceInfoSet, IntPtr lpDeviceInfoData, ref Guid gClass, uint nIndex, ref DeviceInterfaceData oInterfaceData);
		/// <summary>
